...
#define SETPROP(r, s, p) { \
        .v = (const char *[]){ "/bin/sh", "-c", \
             ...
             "| dmenu -l 10 -fn UbuntuMono:pixelsize=28 -p \"$4\" -w $1)\" && " \
...
#define SEARCH() { \
        .v = (const char *[]){ "/bin/sh", "-c", \
             ...
             "$(dmenu -fn UbuntuMono:pixelsize=28 -p 'Brave Search:' -w $1 < /dev/null)\"", \
...
static Key keys[] = {
  ...
  { MODKEY,                GDK_KEY_m,      spawn,      BM_ADD("_SURF_URI") },
	...
	{ MODKEY,                GDK_KEY_rightarrow,      navigate,   { .i = +1 } },
	{ MODKEY,                GDK_KEY_h,      navigate,   { .i = -1 } },
	{ MODKEY,                GDK_KEY_leftarrow,      navigate,   { .i = -1 } },
